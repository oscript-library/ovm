...
&Аргумент(
	Имя = "VERSION",
	Описание = "Используемая версия OneScript. Допустимо использовать трехномерные версии
		|(1.0.17, 1.0.18), stable, dev, а совместно с опцией --install - и сборки с сервера
		|сборок (branch:develop, branch:develop#777, pr:1731, pr:1731#3)")
