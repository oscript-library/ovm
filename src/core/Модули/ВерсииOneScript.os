...
Функция ЭтоТекущаяВерсия(Знач ПроверяемаяВерсия) Экспорт
	...
	ВерсииСимлинков = СимЛинки();
	
	ТекущаяВерсия = ВерсииСимлинков["current"];
...
Функция ПолучитьСписокУстановленныхВерсий() Экспорт
	...
	Для Каждого НайденныйФайл Из НайденныеФайлы Цикл
		...
		СтрокаВерсии.ЭтоСимлинк = ВерсииСимлинков.Получить(НайденныйФайл.Имя) <> Неопределено;
...
Функция СимЛинки()
	...
	ВерсииСимлинков = Новый Соответствие;
	РазделительПути = ПолучитьРазделительПути();
	
	Для Каждого Совпадение Из Совпадения Цикл
		Группы = Совпадение.Группы;
		ЧастиПути = СтрРазделить(Группы[3].Значение, РазделительПути);
		ВерсииСимлинков.Вставить(Группы[2].Значение, ЧастиПути[ЧастиПути.ВГраница()]);
	КонецЦикла;
	
	Возврат ВерсииСимлинков;
