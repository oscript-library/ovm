...
Процедура УстановитьOneScript(
	...
	Попытка
		...
		ДобавитьSHСкриптыПриНеобходимости(КаталогУстановкиВерсии, ВерсияКУстановке, ИспользоватьХ64);
	Исключение
...
Процедура ДобавитьSHСкриптыПриНеобходимости(Знач КаталогУстановкиВерсии, Знач ВерсияКУстановке, Знач ИспользоватьХ64)

	Если СтрНачинаетсяС(ВерсияКУстановке, "2.0") Тогда
		ДобавитьСкриптыДляdotnet(КаталогУстановкиВерсии, ВерсияКУстановке, ИспользоватьХ64);
		Возврат;
	КонецЕсли;
